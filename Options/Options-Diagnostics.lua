...
--[[
    ...
    it always starts off and persists nothing. The ns.OptionsHeader /
    OptionsSpacer helpers do not support `hidden`, so the gated sections inline
    their header widgets with `hidden` functions.
]]
local _, ns = ...
